class SceneManager {
    ...
    loadLevelOne() { //less important is loaded first, then mains. 
        ...
        gameEngine.addEntity(new Ninja(gameEngine, 0, 0));
        gameEngine.addEntity(new Platform(gameEngine, 400, 400, 100));
        gameEngine.addEntity(new Platform(gameEngine, 300, 600, 100));
        gameEngine.addEntity(new Platform(gameEngine, 400, 600, 100));
        gameEngine.addEntity(new Platform(gameEngine, 300, 200, 100));
        ...
        // gameEngine.addEntity(new Platform(gameEngine, 128, 664, 64));
